...
def main(gpu_id, image_dir, model_dir, out_dir, batch_size):
    os.environ["CUDA_DEVICE_ORDER"] = "PCI_BUS_ID"
    os.environ["CUDA_VISIBLE_DEVICES"] = str(gpu_id)

    if not out_dir:
        # out_dir = os.path.join(model_dir, "..", f"prediction_{model_dir.split('/')[-1]}_{image_dir.split('/')[-1]}")
...
parser.add_argument("-m", "--model_dir",
                    default="../../../output/image_segmentation/finalbn_256_alittleaug_iou_2_00/trained_model_fold00.tf",
...
if __name__ == "__main__":
    main(args.gpu_id, args.image_dir, args.model_dir, args.out_dir, args.batch_size)
